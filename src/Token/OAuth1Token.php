 ...
 * Implements OAuth\Token\OAuth1TokenInterface in case of any OAuth1 specific features.
 */
class OAuth1Token extends TokenAbstract implements OAuth1TokenInterface{
