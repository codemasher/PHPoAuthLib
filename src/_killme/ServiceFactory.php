...
class ServiceFactory{
	 ...
	 * @return ServiceFactory
	 *
	 * @throws OauthException If the class is nonexistent or does not implement a valid ServiceInterface
	 */
	public function registerService($serviceName, $className){
		if(!class_exists($className)){
			throw new OauthException(sprintf('Service class %s does not exist.', $className));
		}
		...
		throw new OauthException(sprintf('Service class %s must implement ServiceInterface.', $className));
	}
	 ...
	 * @param \OAuth\_killme\CredentialsInterface $credentials
	...
	private function getFullyQualifiedServiceName($serviceName, $type){
		...
		return '\\OAuth\\Service\\Providers\\'.$type.'\\'.$serviceName;
	}
	 ...
	 * @param Uri|null                            $baseApiUri
	 *
	 * @return \OAuth\Service\ServiceInterface
	 */
